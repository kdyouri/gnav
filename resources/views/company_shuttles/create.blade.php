...
@section('content')
    <div class="row justify-content-center">
        <div class="col-md-8">
            <form method="POST" action="{{ route('company_shuttles.store') }}" novalidate>
                @csrf

                <div class="card">
                    <div class="card-body">
                        <h4 class="mb-3">{{ __('New Shuttle') }}</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input id="departure_time" type="text" class="form-control @error('departure_time') is-invalid @enderror" name="departure_time" value="{{ old('departure_time') }}" required autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="mb-2">
                                    ...
                                    <select id="arrival_city_id" class="form-select @error('arrival_city_id') is-invalid @enderror" name="arrival_city_id" required autocomplete="off">
                                        <option value=""></option>
                                        @foreach($cities as $city)
                                            <option value="{{ $city->id }}"{{ old('arrival_city_id') == $city->id ? ' selected' : '' }}>
                                            {{ $city->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input id="arrival_time" type="text" class="form-control @error('arrival_time') is-invalid @enderror" name="arrival_time" value="{{ old('arrival_time') }}" required autocomplete="off">
                                    @error('arrival_time')
                                    <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input id="price" type="number" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price') }}" required autocomplete="off">
                                    @error('price')
                                    <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input id="passenger_count" type="number" class="form-control @error('passenger_count') is-invalid @enderror" name="passenger_count" value="{{ old('passenger_count') }}" required autocomplete="off">
